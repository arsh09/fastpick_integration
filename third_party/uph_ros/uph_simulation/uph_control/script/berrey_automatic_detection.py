...
class DataCollection: 
    ...
    def move_to_graph_pose(self):
        ...
        if (len(self.berry_translation_from_base) == 3 ):
            ...
            x1 += ( self.pre_grasp_distance - 0.02 )
            # z1 += 0.02
            x2, y2, z2 = wpose.position.x,  wpose.position.y, wpose.position.z  
        ...
        while not rospy.is_shutdown(): 
            ...
            if self.img_msg_received and self.depth_msg_received:
                ...
                if k == 27:   
                    ...
                    if k == ord('n'):
                        self.go_to_home(pose="initial2")

                    if k == ord('5'):
                        self.go_to_home(pose="punnetA")

                    if k == ord('6'):
                        self.go_to_home(pose="punnetB")

                    if k == ord('7'):
                        self.go_to_home(pose="punnetC")

                    if k == ord('8'):
                        self.go_to_home(pose="punnetD")

                    if k == ord('9'):
                        self.go_to_home(pose="pre-place-2")

                    if k == ord('0'):
                        self.go_to_home(pose="pre-place-1")

                    if k == 190:
                        self.go_to_home(pose="punnet1")
                    if k == 191:
                        self.go_to_home(pose="punnet2")
                    if k == 192:
                        self.go_to_home(pose="punnet3")
                    if k == 193:
                        self.go_to_home(pose="punnet4")
                    if k == 194:
                        self.go_to_home(pose="punnet5")
                    if k == 195:
                        self.go_to_home(pose="punnet6")
                    # if k == 196:
                    #     self.go_to_home(pose="punnet7")
                    # if k == 197:
                    #     self.go_to_home(pose="punnet8")
                    # if k == 198:
                    #     self.go_to_home(pose="punnet9")
                    # if k == 199:
                    #     self.go_to_home(pose="punnet10")
                    # if k == 200:
                    #     self.go_to_home(pose="punnet11")
                    # if k == 201:
                    #     self.go_to_home(pose="punnet12")
