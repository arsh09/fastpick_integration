...
from rs_insertPointCloudSeg import MapManager, callback, pointcloud_from_depth, rs_callback, rs_callback_o3d_vtx
...
class MsgManager(object):
    ...
    def process_message(self):
        ...
        # rs_callback_octomap()
        self.MapObj.centers, self.MapObj.depth_point = self.MapObj.rs_callback_cvSeg_rosbag()
